...
<!--		<table id="listRecours" class="table table-condensed table-bordered table-hover"> -->
			<thead>
				<tr>
                                                                            <?php if($_SESSION['langue'] == 'AR'){ 

					echo '<th class="text-center">رقم الطعن</th>';
					echo '<th class="text-center">صاحب الطعن</th>';
					echo '<th class="text-center">الطور / التخصص / التسجيل</th>';
					echo '<th class="text-center">سبب الطعن</th>';
					echo '<th class="text-center">معلومات إضافية عن الطعن</th>';
					echo '<th class="text-center">المادة</th>';
					echo '<th class="text-center">القسم المعني بالطعن</th>';
					echo '<th class="text-center">الأستاذ المعني بالطعن</th>';	
					echo '<th class="text-center">تاريخ تقديم الطعن</th>';
					echo '<th class="text-center">...</th>';
					echo '<th class="text-center">...</th>';
                                                                         }else{
					echo '<th class="text-center">N°</th>';
					echo '<th class="text-center">Auteur du Recours</th>';
					echo '<th class="text-center">Inscription / Spécialité / Cycle</th>';
					echo '<th class="text-center">Motif Recours</th>';
					echo '<th class="text-center">Détails Recours</th>';
					echo '<th class="text-center">Matière</th>';
					echo '<th class="text-center">Département Concerné</th>';					
					echo '<th class="text-center">Enseignant Concerné</th>';	
					echo '<th class="text-center">Date Recours</th>';
					echo '<th class="text-center">...</th>';
					echo '<th class="text-center">...</th>';
                                                                        } ?>
